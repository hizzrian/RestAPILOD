...
$routes->post('artikel', 'Artikel::store', ['filter' => 'auth']);
$routes->get('artikel/(:segment)', 'Artikel::show/$1');
$routes->get('slug', 'Artikel::getAllSlug');
$routes->put('artikel/(:num)', 'Artikel::update/$1', ['filter' => 'auth']);
$routes->delete('artikel/(:num)', 'Artikel::delete/$1', ['filter' => 'auth']);
$routes->get('artikel/edit/(:num)', 'Artikel::edit/$1', ['filter' => 'auth']);
$routes->get('kategori', 'Artikel::getAllKategori');
/*
 * --------------------------------------------------------------------
 * Additional Routing
 * --------------------------------------------------------------------
